									...
									<div id="divForAddRows" class="dvbp-choose_fields-add_button">
										...
										<div class="slds-form-element dvbp-add-button">
											...
											<div class="slds-form-element__control">
												...
												<div class="slds-listbox_object-switcher slds-dropdown-trigger slds-dropdown-trigger_click">
													<button data-add-type="Block" data-add-relation-id="FirstModule,BlockName" data-div-show="LoadShowPopup" onclick="showpopupCreateViewPortal(this);resetFieldCreateViewPortal();" class="slds-button slds-button--neutral slds-button--brand">
														{$MOD.Addsection}
													</button>
												</div>
											</div>
