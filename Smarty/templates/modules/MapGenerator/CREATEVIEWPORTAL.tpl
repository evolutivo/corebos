							...
							<div class="slds-no-flex">
								<div class="actionsContainer mapButton">
									<div class="slds-section-title--divider">
										...
										{/if}
										&nbsp;
										<button class="slds-button slds-button--small slds-button--brand" data-send-data-id="ListData,MapName"   data-send="true"  data-send-url="MapGenerator,saveCreateViewPortal"  data-loading="true" data-loading-divid="LoadingDivId"  data-send-saveas="true" data-send-saveas-id-butoni="SaveAsButton" data-send-savehistory="true" data-save-history="true" data-save-history-show-id="LoadHistoryPopup" data-save-history-show-id-relation="LoadShowPopup" data-send-savehistory-functionname="SavehistoryCreateViewportal">{$MOD.CreateMap}</button
									</div>
								</div>
							</div>
						</div>
										...
										<div class="view-portal-buttons-container">
											<div class="slds-form-element">
												...
												<div class="slds-form-element__control">
													...
													<div class="slds-listbox_object-switcher slds-dropdown-trigger slds-dropdown-trigger_click">
														<button data-add-type="Block" data-add-relation-id="FirstModule,BlockName"  data-div-show="LoadShowPopup" onclick="showpopupCreateViewPortal(this);resetFieldCreateViewPortal();" class="slds-button slds-button--small slds-button--brand slds-cvp--button">{$MOD.Addsection}</button>
													</div>
												</div>
											</div>
										</div>
