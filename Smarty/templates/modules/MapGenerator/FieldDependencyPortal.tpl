					...
					<article class="slds-card forceRelatedListCardDesktop" aria-describedby="header">
						<div class="slds-card__header slds-grid">
								<header class="slds-media--center slds-has-flexi-truncate">
									...
									<p class="slds-text-heading--label slds-line-height--reset">{$MOD.FieldDependencyPortal}</p>
								</header>
					...
					<table class="slds-table slds-table--cell-buffer slds-no-row-hover slds-table--bordered slds-table--fixed-layout small detailview_table">
						<tr class="slds-line-height--reset map-generator-cell-container">
							<td class="dvtCellLabel" valign="top">
								<!-- THE MODULE Zone -->
								<div class="field-dependency-portal-container">
									<!-- Choose Module Container -->
									<div class="field-dependency-portal-module">
									...
									<div class="field-dependency-portal-field">
										<div class="slds-form-element slds-text-align--left">
										...
										<div class="field-dependency-portal-insert-value">
											<div class="slds-form-element slds-text-align--left">
												...
												<div class="slds-form-element__control">
													<div class="slds-combobox_container slds-has-object-switcher">
														...
														<div id="divbutton" class="slds-listbox_object-switcher slds-dropdown-trigger slds-dropdown-trigger_click">
															<button id="AddbuttonFDP" onclick=" AddResponsabileFieldsFD(this);clearInput('DefaultValueResponsibel');" data-add-button-popup="false" data-add-button-validate="Firstfield" data-add-type="Responsible" data-add-relation-id="FirstModule,DefaultValueResponsibel,Firstfield,Conditionalfield" data-show-id="Firstfield" data-div-show="LoadShowPopup" class="slds-button slds-button_icon" aria-haspopup="true" title="Click to add">
...
<div id="generatedquery"><div id="results" style="margin-top: 1%;"></div></div>
		...
		<div class="slds-modal" aria-hidden="false" role="dialog" id="fields">
			<div class="slds-modal__container">
				...
				<div class="slds-modal__footer">
					...
					<button class="slds-button slds-button--small slds-button--brand" onclick="AddResponsabileFieldsFD(this);"  data-add-button-popup="false" data-add-button-validate="Firstfield2" data-add-type="Field" data-add-relation-id="FirstModule,Firstfield2,ShowHidecheck,Readonlycheck,mandatorychk" data-show-id="Firstfield2" data-div-show="LoadShowPopup">
						{$MOD.Add}
					</button>
		...
		<div class="slds-modal" aria-hidden="false" role="dialog" id="Picklist">
			<div class="slds-modal__container">
				...
				<!-- Modal Footer -->
					<div class="slds-modal__footer">
						{*<label id="ErrorLabelModal"></label> *}
						<button class="slds-button slds-button--small slds-button--brand" id="AddToArray" data-add-button-popup="false"  onclick="AddResponsabileFieldsFD(this);RestoreDataEXFIM(this);" data-add-button-validate="PickListFields"  data-add-type="Picklist" data-add-relation-id="FirstModule,PickListFields,DefaultValueFirstModuleField_1" data-show-id="PickListFields" data-div-show="LoadShowPopup" onclick="Checkifexist();removedataafterclick();">
							{$MOD.Add}
						</button>
						<!-- data-send-savehistory="{$savehistory}" -->
