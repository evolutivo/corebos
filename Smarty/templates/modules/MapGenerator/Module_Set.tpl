                                ...
                                <td class="dvtCellLabel" width="70%" style="vertical-align: top;">
                                        <!-- THE MODULE Zone -->
                                          <div id="selJoin" style="float:left; overflow: hidden;width:100%;height: 100%">
                                              ...
                                              <div class="slds-listbox_object-switcher slds-dropdown-trigger slds-dropdown-trigger_click" style="margin:22px 0px 10px 5px;padding: 0px;width: 47px;height: 39px;    float: left;">
                                                  <button data-add-button-popup="true" data-add-type="Module" data-add-relation-id="HistoryValueToShow,FirstModule,FirstModule" data-add-button-validate="FirstModule" data-show-id="" data-div-show="LoadShowPopup" class="slds-button slds-button_icon" aria-haspopup="true" title="Click to add " style="width:2.1rem;">
