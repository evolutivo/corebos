...
<div class="slds-grid slds-grid--vertical slds-navigation-list--vertical" style="float:left; overflow: hidden;width:20%" id="buttons" >

 <ul id="LDSstyle">
    <li><a href="javascript:void(0);" id="addJoin" name="radio"  onclick="generateJoin();" class="slds-navigation-list--vertical__action slds-text-link--reset" aria-describedby="entity-header">{$MOD.AddJoin}</a></li>
...
*} 
 ...
 {*       <select class="sel" id="mod" name="mod"></select> 
        ...
        <input type="button" class="slds-button slds-button--neutral sel"  id="selField1" name="selField1" style="padding:0px;">
        </div>
		...
		<div class="slds-form-element">
			 <div class="slds-form-element__control">
				<div class="slds-select_container">
				  <select id="secmodule" name="secmodule" onchange="GetSecondModuleCombo(this)" class="slds-select">
				  </select>
				</div>
			</div>
	    </div>
 {*       <select class="sel" id="secmodule" name="secmodule">
        ...
        <input type="button" class="slds-button slds-button--neutral sel" id="selField2" name="selField2" style="padding:0px;">
        </div> 
    </div>
    <br><br>
    <div id="contenitoreJoin">
        ...
        <div id="sectionField">
            ...
            <div>
                <div class="testoDiv"><center><b>{$MOD.SelectField}</b></center></div>
				<div class="slds-form-element">
...
.ajax_loader {background: url("modules/MVCreator/image/spinner_squares_circle.gif") no-repeat center center transparent;width:100%;height:100%;}
.blue-loader .ajax_loader {background: url("modules/MVCreator/image/ajax-loader_blue.gif") no-repeat center center transparent;}
