...
<table align="center" border="0" cellpadding="5" cellspacing="0" width="100%" class="mailSubHeader">
	...
	{if $EXPORT_PERMITTED eq 'YES'}
		<td align="left" nowrap ><input class="crmbutton small create" id="btnExport" name="btnExport" value="{$MOD.LBL_EXPORTPDF_BUTTON}" type="button" onClick="goToURL(CrearEnlace('CreatePDFSQL',{$REPORTID}));" title="{$MOD.LBL_EXPORTPDF_BUTTON}"></td>
		<td align="left" nowrap ><input class="crmbutton small create" id="btnExport" name="btnExport" value="{$MOD.LBL_EXPORTXL_BUTTON}" type="button" onClick="goToURL(CrearEnlace('CreateXLSQL',{$REPORTID}));" title="{$MOD.LBL_EXPORTXL_BUTTON}" ></td>
	{/if}
