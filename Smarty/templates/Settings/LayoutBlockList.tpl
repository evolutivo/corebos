...
function getCreateCustomFieldFormold(modulename,blockid,mode)
{
   ...
   jQuery.ajax({        url:'index.php?',
			type: 'POST',
			data: 'module=Settings&action=SettingsAjax&file=LayoutBlockList&sub_mode=addCustomField&fld_module='+modulename+'&ajax=true&blockid='+blockid+'&fieldType='+type+'&fldLabel='+label+'&fldLength='+fldLength+'&fldDecimal='+fldDecimal+'&fldPickList='+fldPickList,
...
/* ++++ MP Custom Field on primary table   */
			data: 'module=Settings&action=SettingsAjax&file=LayoutBlockList&sub_mode=addCustomField&fld_module='+modulename+'&ajax=true&blockid='+blockid+'&fieldType='+type+'&fldLabel='+label+'&fldLength='+fldLength+'&fldDecimal='+fldDecimal+'&fldPickList='+fldPickList+'&fldVTable='+fldVTable+'&fldColName='+fldColName+'&numfields='+fldNumField+'&relationmodules='+relationmodules,
/* ++++ MP Custom Field on primary table   */
...
function makeFieljadSelected(oField,fieldid,blockid)
{
	if(gselected_fieldtype != '')
	{
		document.getElementById(gselected_fieldtype).className = 'customMnu';
