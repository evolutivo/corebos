				...
				<tr>
					<td class="small">
						...
						<tr>
							...
							<td class="cellText small" align="left"><input id="folder_desc" name="folderDesc" class="txtBox slds-input" type="text" placeholder="{$MOD.LBL_MAXIMUM_50}"></td>
						</tr>
						</table>
					</td>
				</tr>
