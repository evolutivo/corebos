									...
									<th scope="col">
										<div class="globalCreateContainer oneGlobalCreate">
											...
											{if $MODULE eq 'Calendar4You'}
												...
												{/if}
												<div id="LB_TaskIcon" class="LB_Button slds-trunacte"><a href='index.php?module=Calendar&action=index'><img src="themes/images/tasks-icon.png" alt="{'Tasks'|getTranslatedString:$MODULE}" title="{'Tasks'|getTranslatedString:$MODULE}" border="0"></a></div>
											{/if}
											</div>
										</div>
									</th>
