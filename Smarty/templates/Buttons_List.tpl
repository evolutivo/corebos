...
<tr class="slds-text-title--caps">
	...
	<th scope="col" style="padding: 1rem 1.5rem 0.5rem 1.5rem;">
                        ...
                        <tr>
                            <th scope="col">
                                {if $CHECK.CreateView eq 'yes' && ($MODULE eq 'Calendar' || $MODULE eq 'Calendar4You')}
                                    {*<td id="LB_AddButton" class="LB_Button" style="padding-right:0px;padding-left:10px;">*}
                ...
                <td class="small">
                    ...
                    <table class="slds-table slds-no-row-hover">
                        <tr>
                            ...
                            {else}
                                <div id="LB_ImportButtonFaded" class="LB_Button slds-truncate"><img src="{'tbarImport-Faded.gif'|@vtiger_imageurl:$THEME}" border="0"></div>
                            {/if}
                            </th>
                            <th scope="col">
                            ...
                            {else}
                                <div id="LB_ExportButtonFaded" class="LB_Button slds-truncate"><img src="{'tbarExport-Faded.gif'|@vtiger_imageurl:$THEME}" border="0"></div>
                            {/if}
                            </th>
                            <th scope="col">
                            ...
                            {else}
                                <div id="LB_FindDuplButtonFaded" class="LB_Button slds-truncate"><img src="{'FindDuplicates-Faded.gif'|@vtiger_imageurl:$THEME}" border="0"></div>
                            {/if}
                            </th>
                        </tr>
                    </table>
