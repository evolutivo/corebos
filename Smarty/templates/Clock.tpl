...
<div id="wclock" style="z-index:10000001;" class="layerPopup">
	<table class="slds-table slds-no-row-hover" width="100%">
		<tr class="slds-text-title--header" style="cursor:move;">
			<th scope="col" id="Handle">
				<div class="slds-truncate moduleName">
					<b>{$APP.LBL_WORLD_CLOCK}</b>
				</div>
			</th>
			<th scope="col" style="text-align:right; padding: .5rem;">
	...
	<table class="layerPopup" align="center" border="0" cellpadding="2" cellspacing="0" width="100%">
				...
				<div style="background-image: url({$IMAGEPATH}clock_bg.gif); background-repeat: no-repeat; background-position: 4px 38px;" id="theClockLayer">
					<div id="theCities" class="citystyle">
						<form action="" name="frmtimezone">
							<select name="clockcity" size="1" class="importBox slds-select" id="clockcity" style="width:125px;height: 28px;" onchange="lcl(this.selectedIndex,this.options[0].selected)">
