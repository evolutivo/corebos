		...
		<td>
				...
				<tr class="slds-text-title--caps">
					{if $recid_var_value neq ''}
							<th scope="col" style="padding: 1rem 1.5rem 1rem 1rem;">
								<div class="slds-truncate moduleName">{$MODULE|@getTranslatedString:$MODULE}&nbsp;{$APP.LBL_RELATED_TO}&nbsp;{$PARENT_MODULE|@getTranslatedString:$PARENT_MODULE}
							</th>
					{else}
						{if $RECORD_ID}
							<th scope="col" style="padding: 1rem 1.5rem 1rem 1rem;">
			...
			<form name="advSearch" method="post" action="index.php" onSubmit="callSearch('Advanced');return false">
				...
				<table border=0 cellspacing=0 cellpadding=5 width=100% class="searchUIAdv3 small" align="center">
					<tr>
						<td align="center" class="small"><input type="button" class="slds-button--small slds-button_success slds-button" value=" {$APP.LBL_SEARCH_NOW_BUTTON} " onClick="callSearch('Advanced');">
						</td>
					</tr>
				</table>
			</form><br>
