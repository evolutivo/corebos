	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tbody><tr>
					...
					<td class="heading2" valign="bottom"><b><a href="index.php?module=UserSettings&action=index">{'LBL_USERSETTINGS'|@getTranslatedString}</a> > <a href="index.php?module=Settings&action=ListProfiles&parenttab=Settings">{$CMOD.LBL_PROFILE_PRIVILEGES}</a> &gt; {$CMOD.LBL_VIEWING} &quot;{$PROFILE_NAME}&quot;</b></td>
				</tr>
				<tr>
