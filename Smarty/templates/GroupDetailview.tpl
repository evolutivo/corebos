	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=UserSettings&action=index">{'LBL_USERSETTINGS'|@getTranslatedString}</a> > <a href="index.php?module=Settings&action=listgroups&parenttab=Settings">{$CMOD.LBL_GROUPS}</a> &gt; {$CMOD.LBL_VIEWING} &quot;{$GROUPINFO.0.groupname}&quot; </b></td>
				</tr>
				<tr>
