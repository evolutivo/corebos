...
function DatePickerCtrl($scope, $mdDialog, $mdMedia, $timeout, currentDate, options) {
    ...
    this.minDate = options.minDate && moment(options.minDate,'YYYY-MM-DD').isValid() ? moment(options.minDate,'YYYY-MM-DD') : null;
    this.maxDate = options.maxDate && moment(options.maxDate,'YYYY-MM-DD').isValid() ? moment(options.maxDate,'YYYY-MM-DD') : null;
    ...
    return  {
        ...
        link: {
            ...
            post: function(scope, element, attrs, ngModel, $transclude) {
                attrs.$observe('mdpMinDate', function(newValue) {
                          if(newValue!=undefined && newValue!='' && newValue!=null){
                          scope.minDate = newValue;
                          }
                });
                 attrs.$observe('mdpMaxDate', function(newValue) {
                          if(newValue!=undefined && newValue!='' && newValue!=null){
