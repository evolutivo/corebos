...
function updateUser2RoleMapping($roleid,$userid)
{
	...
	$sqlcheck = 'select userid from vtiger_user2role where userid=? limit 1';
...
function isPermittedBusinessRule($module,$actionname)
{
    ...
    $q_business_rule="Select businessrule,linktomap"
                    ...
                    ." join vtiger_cbmap on vtiger_businessrules.linktomap=vtiger_cbmap.cbmapid
                       join vtiger_crmentity on vtiger_crmentity.crmid=cbmapid and vtiger_crmentity.deleted=0"
                    ." where module_rules=?"
...
function getDefOrgShareActionName($share_action_id)
{
	...
	$query="select share_action_name from vtiger_org_share_action_mapping where share_action_id=?";
