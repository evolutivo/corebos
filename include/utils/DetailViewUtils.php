...
function getDetailViewOutputHtml($uitype, $fieldname, $fieldlabel, $col_fields, $generatedtype, $tabid = '', $module = '', $cbMapFI = array()) {
	...
	if ($uitype == '10') {
		...
		if ($fieldname=='notecontent' || ($module=='Emails' || $module=='Timecontrol' || $module=='Thread' || $module=='Messages') || ($fieldname=='signature' && $module=='Users') || (isset($cbMapFI['RTE']) && $cbMapFI['RTE'] && vt_hasRTE())) {
