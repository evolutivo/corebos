...
angular.module('demoApp.directives', []).
        ...
        directive('navbar', ['$location', function ($location) {
            return {
                ...
                templateUrl: 'modules/ElasticSearch/template/navbar/navbar.html',
                replace: true,
        ...
        directive('navbaritem', [function () {
            return {
                require:'^navbar',
                restrict: 'E',
                templateUrl: 'modules/ElasticSearch/template/navbar/navbaritem.html',
                replace: true,
        ...
        directive('navbardropdownitem', [function () {
            return {
                ...
                restrict: 'E',
                scope:{"theLink":"@link","theTitle":"@title"},
                templateUrl: 'modules/ElasticSearch/template/navbar/navbardropdownitem.html',
                replace: true,
                link: function ($scope, $element, $attrs, navbarCtrl) {
//                    $scope.item={"title": $attrs['title'], "link": $attrs['link'], "selected": false};
//                    navbarCtrl.addItem($scope.item);
        ...
        directive('navbardropdown', [function () {
            return {
                ...
                templateUrl: 'modules/ElasticSearch/template/navbar/navbardropdown.html',
                replace: true,
                link: function ($scope, $element, $attrs, navbarCtrl) {
