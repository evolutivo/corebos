...
class ProcessFlow extends CRMEntity {
	...
	var $def_basicsearch_col = 'processflowname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'processflowname';

	// Required Information for enabling Import feature
	var $required_fields = Array('processflowname'=>1);
	...
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'processflowname');
