...
global $theme,$mod_strings,$app_strings,$current_user,$currentModule,$current_language,$default_charset;
	...
	<input type="hidden" name="gevent_userid" value="">
		...
		<td class=small >
			...
			<td width=80% align="left">
				<table>
					<tr><td>
							<?php echo getITSActFieldCombo('activitytype','vtiger_activitytype'); ?>
					</td></tr>
				</table>
			</td>
			</tr>
			...
			<?php if(getFieldVisibilityPermission('Events',$current_user->id,'visibility', 'readwrite') == '0') {
				$visrs = $adb->query("select defaultvalue from vtiger_field where tabid=16 and columnname='visibility'");
			...
			<tr>
				<td valign="top" align="right"><b><?php echo $c_mod_strings['Description']?></b></td>
			...
			<tr>
				<td colspan=2 width=80% align="center">
					...
					<tr>
						...
						<td ><b><font color="red">*</font><?php echo $c_mod_strings['Status'] ; ?></b></td>
						<?php } ?>
						<?php if(getFieldVisibilityPermission('Events',$current_user->id,'assigned_user_id', 'readwrite') == '0') { ?>
						<td ><b><?php echo $c_mod_strings['Assigned To']; ?></b></td>
						<?php } ?>
					</tr>
					<tr>
						<?php if(getFieldVisibilityPermission('Events',$current_user->id,'eventstatus', 'readwrite') == '0') { ?>
						...
						<td valign=top rowspan=2>
							...
							<input type="checkbox" name="sendnotification" >&nbsp;<?php echo $c_mod_strings['LBL_SENDNOTIFICATION'] ?>
							<?php } ?>
						</td>
					</tr>
					<?php if(getFieldVisibilityPermission('Events',$current_user->id,'taskpriority', 'readwrite') == '0') { ?>
					<tr>
						<td valign=top><b><?php echo $c_mod_strings['Priority'] ; ?></b>
			...
			<?php
				...
				$smarty2->assign("MOD",$c_mod_strings);
				$smarty2->assign("APP",$app_strings);
				$theme_path="themes/".$theme."/";
				$image_path=$theme_path."images/";
			...
			<td>
				...
				<tr>
					...
					<td id="cellTabRelatedto" class="dvtSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','off');switchClass('cellTabAlarm','off');switchClass('cellTabRepeat','off');switchClass('cellTabRelatedto','on');ghide('addITSEventAlarmUI');ghide('addITSEventInviteUI');gshow('addITSEventRelatedtoUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addITSEventRepeatUI');"><?php echo $c_mod_strings['LBL_RELATEDTO']?></a></td>
					<td class="dvtTabCache" style="width:10px">&nbsp;</td>
					<td id="cellTabInvite" class="dvtUnSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','on');switchClass('cellTabAlarm','off');switchClass('cellTabRepeat','off');switchClass('cellTabRelatedto','off');ghide('addITSEventAlarmUI');gshow('addITSEventInviteUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addITSEventRepeatUI');ghide('addITSEventRelatedtoUI');"><?php echo $c_mod_strings['LBL_INVITE']?></a></td>
					<td class="dvtTabCache" style="width:10px">&nbsp;</td>
			...
			<td width=100% valign=top align=left class="dvtContentSpace" style="padding:10px;height:120px">
				<!-- Related to UI -->
				<div id="addITSEventRelatedtoUI" style="display:block;width:100%">
				...
				<?php if(getFieldVisibilityPermission('Events',$current_user->id,'parent_id', 'readwrite') == '0') { ?>
						<tr>
							...
							<input type="button" name="selectparent" class="crmButton small edit" value="<?php echo $c_mod_strings['LBL_SELECT']; ?>" onclick="return window.open('index.php?module='+document.EditView.parent_type.value+'&action=Popup','test','width=640,height=602,resizable=0,scrollbars=0,top=150,left=200');">
			...
			<!-- Invite UI -->
				<DIV id="addITSEventInviteUI" style="display:none;width:100%">
					...
					<td valign=top>
						...
						<tr>
							...
							<td width=20% align=center valign=top>
								...
								<input type=button value="<< <?php echo $c_mod_strings['LBL_RMV_BUTTON'] ?> " class="crm button small cancel" style="width:100%" onClick="rmvUser('selectedusers')">
							</td>
							<td width=40% align=center valign=top>
				...
				<tr>
					...
					<td nowrap width=80% valign=top>
						...
						<tr>
							...
							<td><?php echo $c_mod_strings['LBL_ENABLE_REPEAT']?></td>
						</tr>
						<tr>
							<td colspan=2>
							<div id="repeatOptions" style="display:none">
								...
								<tr>
								<td>
									<?php echo $c_mod_strings['LBL_REPEATEVENT']; ?>
								</td>
								...
								<td>
									<select name="recurringtype" onChange="rptoptDisp(this)" class="small">
										<option value="Daily"><?php echo $c_mod_strings['LBL_DAYS']; ?></option>
										<option value="Weekly"><?php echo $c_mod_strings['LBL_WEEKS']; ?></option>
										<option value="Monthly"><?php echo $c_mod_strings['LBL_MONTHS']; ?></option>
										<option value="Yearly"><?php echo $c_mod_strings['LBL_YEAR']; ?></option>
									</select>
								...
								<table border=0 cellspacing=0 cellpadding=2>
									<tr>
								<td><input name="sun_flag" value="sunday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_SUN']; ?></td>
								<td><input name="mon_flag" value="monday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_MON']; ?></td>
								<td><input name="tue_flag" value="tuesday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_TUE']; ?></td>
								<td><input name="wed_flag" value="wednesday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_WED']; ?></td>
								<td><input name="thu_flag" value="thursday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_THU']; ?></td>
								<td><input name="fri_flag" value="friday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_FRI']; ?></td>
								<td><input name="sat_flag" value="saturday" type="checkbox"></td><td><?php echo $c_mod_strings['LBL_SM_SAT']; ?></td>
									</tr>
								</table>
								</div>
								...
								<table border=0 cellspacing=0 cellpadding=2 bgcolor="#FFFFFF">
									<tr>
										<td>
											<table border=0 cellspacing=0 cellpadding=2>
												<tr>
													<td><input type="radio" checked name="repeatMonth" value="date"></td><td><?php echo $c_mod_strings['on'];?></td><td><input type="text" class=textbox style="width:20px" value="2" name="repeatMonth_date" ></td><td><?php echo $c_mod_strings['day of the month'];?></td>
												</tr>
											</table>
										</td>
									</tr>
										...
										<td>
											<table border=0 cellspacing=0 cellpadding=2>
												<tr>
													...
													<td><?php echo $c_mod_strings['on'];?></td>
													<td>
													...
													<td>
														<select name="repeatMonth_day">
															<option value=1><?php echo $c_mod_strings['LBL_DAY1']; ?></option>
															<option value=2><?php echo $c_mod_strings['LBL_DAY2']; ?></option>
															<option value=3><?php echo $c_mod_strings['LBL_DAY3']; ?></option>
															<option value=4><?php echo $c_mod_strings['LBL_DAY4']; ?></option>
															<option value=5><?php echo $c_mod_strings['LBL_DAY5']; ?></option>
															<option value=6><?php echo $c_mod_strings['LBL_DAY6']; ?></option>
														</select>
													</td>
												</tr>
											</table>
...
<form id="createTodoID" name="createTodo" method="POST" action="index.php">
				...
				<table border="0" cellpadding="3" cellspacing="0" width="80%">
					<tr>
						<td align="left">
							...
							<b><?php echo $c_mod_strings['Status']; ?></b><br>
						...
						<td align="left">
							...
							<b><?php echo $c_mod_strings['Assigned To']; ?></b><br>
					...
					<tr>
						<td align="left">
							...
							<b><?php echo $c_mod_strings['Priority']; ?></b><br>
							<?php echo getITSActFieldCombo('taskpriority','vtiger_taskpriority','Calendar'); ?>
							<?php } ?>
						</td>
						<td align="left" valign="top">
							<input name="task_sendnotification" type="checkbox">&nbsp;<?php echo $c_mod_strings['LBL_SENDNOTIFICATION'] ?>
						</td>
					</tr>
				</table>
			</td>
			...
			<table border="0" cellpadding="2" cellspacing="0" width="100%" align=center>
				<tr><td width=50% valign=top style="border-right:1px solid #dddddd">
					<table border=0 cellspacing=0 cellpadding=2 width=95% align=center>
						<tr><td colspan=3 align="left"><b><?php echo $c_mod_strings['LBL_TODODATETIME'] ?></b></td></tr>
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#FFFFFF">
		...
		<tr>
			<td width=100% valign=top align=left class="dvtContentSpace" style="padding:10px;height:120px">
		<div id="addITSTaskRelatedtoUI" style="display:block;width:100%">
			<table width="100%" cellpadding="5" cellspacing="0" border="0">
			<?php if(getFieldVisibilityPermission('Calendar',$current_user->id,'parent_id', 'readwrite') == '0') { ?>
			<tr>
				<td><b><?php echo $c_mod_strings['LBL_RELATEDTO']?></b></td>
				<td>
				...
				<td>
					...
					<input type="button" name="selectparent" class="crmButton small edit" value="<?php echo $c_mod_strings['LBL_SELECT']; ?>" onclick="return window.open('index.php?module='+document.createTodo.task_parent_type.value+'&action=Popup&maintab=Calendar','test','width=640,height=602,resizable=0,scrollbars=0,top=150,left=200');">
