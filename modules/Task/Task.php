...
class Task extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'LBLTASKNAME'=> Array('task'=> 'taskname'),
	...
	var $popup_fields = Array('taskname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'taskname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'taskname';

	// Required Information for enabling Import feature
	var $required_fields = Array('taskname'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'taskname';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'taskname');
	...
	//function get_dependents_list($id, $cur_tab_id, $rel_tab_id, $actions=false) { }
		...
		$parenttab = getParentTab();
                 $this->retrieve_entity_info($id,$currentModule);
...
function insertIntoInviteeTable($module,$inviteesid)
{
		global $log,$adb;
