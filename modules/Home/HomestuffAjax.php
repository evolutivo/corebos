...
if (!empty($modval)) {
	...
	if ($adb->num_rows($result)==0) {
		...
		$html = '<select id=selFilterid name=selFiltername onchange=setPrimaryFld(this) class="slds-select" onfocus="this.className=\'detailedViewTextBoxOn\'" ';
...
if (!empty($dash)) {
	...
	$html  = '<select name=seldashbd id=seldashbd_id class="slds-select" onfocus="this.className=\'detailedViewTextBoxOn\'" ';
	$html .= ' onblur="this.className=\'detailedViewTextBox\'" style="width:60%">';
...
if (!empty($_REQUEST['primecvid'])) {
	...
	if ($adb->num_rows($result)==0) {
		...
		$html = '<select id=selPrimeFldid name=PrimeFld multiple class="slds-select" onfocus="this.className=\'detailedViewTextBoxOn\'"';
		$html.= ' onblur="this.className=\'detailedViewTextBox\'" style="width:60%">';
		for ($i=0; $i<$adb->num_rows($result); $i++) {
