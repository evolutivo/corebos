...
if($_REQUEST['mode'] == 'RUNREPORT')
{
//error_reporting(E_ALL);
//ini_set('display_errors', 1);
    include 'modules/SQLReports/RunSQL.php';
}
else
{
    ...
    $smarty->assign('CUSTOM_LINKS', Vtiger_Link::getAllByType_Link(getTabid($currentModule), Array('DETAILVIEWBASIC','DETAILVIEW'), $customlink_params));
    // END
