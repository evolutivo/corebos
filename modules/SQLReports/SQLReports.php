...
class SQLReports extends CRMEntity {
	...
	var $table_name = 'vtiger_sqlreports';
	var $table_index= 'sqlreportsid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_sqlreportscf', 'sqlreportsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_sqlreports', 'vtiger_sqlreportscf');
	...
	var $popup_fields = Array ('reportnum');

	// Allow sorting on the following (field column names)
	var $sortby_fields = Array ('reportnum');

	// Should contain field labels
	//var $detailview_links = Array ('Report ID');

	// For Alphabetical search
	var $def_basicsearch_col = 'reportnum';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'reportnum';
	...
	var $default_order_by = 'reportnum';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'reportnum');
