...
global $log;$log->Debug('futkot');
$log->Debug($listview_entries);
$extralinks='<script language="JavaScript" type="text/javascript" src="modules/Reports/Reports.js"></script>
...
foreach($listview_entries as $key=>$value){
    $extralinks.= '<a href="" id="btnExport" name="btnExport" value="'.getTranslatedString('LBL_EXPORTPDF_BUTTON').'" type="button" onClick="goToURL(\'index.php?module=SQLReports&action=CreatePDFSQL&record='.$key.'\');" title="'.getTranslatedString('LBL_EXPORTPDF_BUTTON').'">'.getTranslatedString('LBL_EXPORTPDF_BUTTON').'</a>
 | <a href="" name="PrintReport" value="'.getTranslatedString('LBL_PRINT_REPORT').'" onClick="window.open(\'index.php?module=SQLReports&action=SQLReportsAjax&file=PrintReportSQL&record='.$key.'\')"  type="button">'.getTranslatedString('LBL_PRINT_REPORT').'</a>
 | <a href="" id="btnExport" name="btnExport"  onClick="goToURL(\'index.php?module=SQLReports&action=CreateXLSQL&record='.$key.'\');" title="'.getTranslatedString('LBL_EXPORTXL_BUTTON').'" />'.getTranslatedString('LBL_EXPORTXL_BUTTON').'</a>
| <a href="index.php?action=DetailView&module=SQLReports&record='.$key.'&mode=RUNREPORT">View report</a>	        
';
			
    $listview_entries[$key][3]=$value[3].' | '.$extralinks;
}
