...
class Employees extends CRMEntity {
	 ...
	 */
	var $customFieldTable = Array('vtiger_employeescf', 'employeeid');
	...
	var $required_fields = Array('employeeno'=>1);
	...
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'employeeno');
