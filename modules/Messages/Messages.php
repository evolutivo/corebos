...
class Messages extends CRMEntity {
	...
	var $table_name = 'vtiger_messages';
	 ...
	 */
	var $customFieldTable = Array('vtiger_messagescf', 'messagesid');
    // Uncomment the line below to support custom field columns on related lists
    // var $related_tables = Array('vtiger_payslipcf'=>array('payslipid','vtiger_payslip', 'payslipid'));
	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_messages', 'vtiger_messagescf');
	...
	var $list_link_field = 'messagesname';
	...
	var $popup_fields = Array('messagesname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'messagesname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'messagesname';

	// Required Information for enabling Import feature
	var $required_fields = Array('messagesname'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'messagesname';
