...
$reportIndexFields["AccountName"]=array("type"=>"string","index"=>"not_analyzed");
$reportIndexFields["AccountNo"]=array("type"=>"string","index"=>"not_analyzed");
$reportIndexFields["ModifiedTime"]=array("type"=>"date","format"=>"yyyy-MM-dd HH:mm:ss");
...
$selectedMapColumns = explode(",","accountid,AccountName,AccountNo,ModifiedTime");
$ip= "193.182.16.34";
$index= "evolutivocore_accountlog2";
$entityfield= "accountid";
$mapSql= "SELECT vtiger_account.accountid, vtiger_account.accountname, vtiger_account.account_no, vtiger_crmentity.modifiedtime FROM vtiger_account  INNER JOIN vtiger_crmentity ON vtiger_account.accountid = vtiger_crmentity.crmid  WHERE vtiger_crmentity.deleted=0 AND vtiger_account.accountid > 0";
