...
class cbValidations extends CRMEntity {
	...
	var $table_name = 'vtiger_cbvalidations';
	var $table_index= 'cbvalidationsid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbvalidationscf', 'cbvalidationsid');
	...
	// var $related_tables = Array('vtiger_cbvalidationscf'=>array('cbvalidationsid','vtiger_cbvalidations', 'cbvalidationsid'));

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbvalidations', 'vtiger_cbvalidationscf');
	...
	var $list_link_field = 'cbvalidationsname';
	...
	var $popup_fields = Array('cbvalidationsname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'cbvalidationsname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'cbvalidationsname';

	// Required Information for enabling Import feature
	var $required_fields = Array('cbvalidationsname'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'cbvalidationsname';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'cbvalidationsname');
