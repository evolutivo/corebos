...
class cbSignature extends CRMEntity {
	...
	var $table_name = 'vtiger_cbsignature';
	var $table_index= 'cbsignatureid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbsignaturecf', 'cbsignatureid');
	// Uncomment the line below to support custom field columns on related lists
	// var $related_tables = Array('vtiger_unsolveddetailscf'=>array('unsolveddetailsid','vtiger_unsolveddetails', 'unsolveddetailsid'));

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbsignature', 'vtiger_cbsignaturecf');
	...
	var $list_link_field = 'signaturename';
	...
	var $popup_fields = Array('signaturename');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'signaturename';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'signaturename';

	// Required Information for enabling Import feature
	var $required_fields = Array('signaturename'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'signaturename';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'signaturename');
