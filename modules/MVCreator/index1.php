<link rel="stylesheet" href="modules/MVCreator/css/style.css" />
<script src="modules/MVCreator/functions.js"></script>
...
var installation = jQuery("#accinsdata").val(); 
    ...
    jQuery("#modscriptsel").kendoDropDownList({
              ...
              dataSource: {
                 transport: {
                 read: {
                    url:"index.php?module=MVCreator&action=MVCreatorAjax&file=getInstallationEntities&installation="+installation,
                    dataType: "json",
                }
                },
...
var accdataSource = new kendo.data.DataSource({
  ...
  transport: {
    read: {
      url: "index.php?module=MVCreator&action=MVCreatorAjax&file=getAccount",
      dataType: "json"
    }
  }
});
...
var accins = jQuery("#accins").kendoDropDownList({
    ...
    dataSource: {
         transport: {
           read: {
               url:"index.php?module=MVCreator&action=MVCreatorAjax&file=getAccountInstallation",
               dataType: "json",
           }
         },
       serverFiltering: true,
...
<div id="mvcontainer">
     <div id="mvmenu">
        ...
        <div id="pulsantiMenù">
                ...
                <button style="width:19%;" class="pulsante" onclick="window.open('index.php?module=MVCreator&action=MVCreatorAjax&file=tabellascript&nr=0','CREA SCRIPT','width=640,height=602,resizable=0,scrollbars=1');">Creazione script report</button>
<!--                <button style="width:19%;" class="pulsante" onclick="createReportScript(0);">Creazione script report</button>
                ...
                <button style="width:19%;" class="pulsante" onclick="window.open('index.php?module=MVCreator&action=MVCreatorAjax&file=tabellascript&nr=1','CREA SCRIPT','width=640,height=602,resizable=0,scrollbars=1');">Creazione script Name report</button>
