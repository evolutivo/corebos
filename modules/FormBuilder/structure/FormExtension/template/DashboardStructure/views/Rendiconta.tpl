                  ...
                  <td ng-if="$index%2==0" style="padding-right:7px;" width="65%" >
                        <div class="column"  >
                            ...
                            <ul class="cards card-list"  ng-model="column.cards"> 
                             <a ng-if="$index%2==0" title="Cambia Stato" ng-click="addNewCard(kanbanBoard.columns[sec_col]);processflowselected(card.pfid,card.currentid);"  ng-repeat="card in column.cards"> 
