  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        rendererControl = $("<td>");
        renderer = $("<select id='typechart'>").addClass('pvtRenderer').appendTo(rendererControl).bind("change", function() {
          return refresh();
        });
        ...
        aggregator = $("<select id='aggr'>").addClass('pvtAggregator').bind("change", function() {
          return refresh();
        });
          ...
          return function() {
            ...
            if (numInputsToProcess !== 0) {
              ...
              for (x = _m = 0; 0 <= numInputsToProcess ? _m < numInputsToProcess : _m > numInputsToProcess; x = 0 <= numInputsToProcess ? ++_m : --_m) {
                newDropdown = $("<select id='aggrdrop'>").addClass('pvtAttrDropdown').append($("<option>")).bind("change", function() {
                  return refresh();
                });
