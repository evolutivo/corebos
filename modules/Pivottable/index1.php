...
<html>
    <head>
         ...
         <link rel="stylesheet" type="text/css" href="modules/Pivottable/pivottable-master/dist/pivot.css">
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/examples/ext/d3.v3.min.js"></script>
        <script type="text/javascript" src="https://www.google.com/jsapi"></script>
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/examples/ext/jquery-1.8.3.min.js"></script>
       
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/examples/ext/jquery-ui-1.9.2.custom.min.js"></script>
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/examples/ext/jquery.csv-0.71.min.js"></script>
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/dist/pivot.js"></script>
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/dist/gchart_renderers.js"></script>
        <script type="text/javascript" src="modules/Pivottable/pivottable-master/dist/d3_renderers.js"></script>
