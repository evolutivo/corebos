...
define('USER_ID', '58b45a5aab31ca37b967b774');
...
$focusnew->mode='';
$q=$adb->query("select * from vtiger_account join vtiger_crmentity on crmid=accountid where deleted=0 and email1='$emailid'");
if($adb->num_rows($q)==0)
{
$q=$adb->query("select * from vtiger_contactdetails join vtiger_crmentity on crmid=contactid where deleted=0 and email='$emailid'");  
