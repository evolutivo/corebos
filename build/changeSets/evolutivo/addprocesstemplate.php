...
class addprocesstemplate extends cbupdaterWorker {
	...
	function applyChange() {
		...
		if ($this->isApplied()) {
			...
			$toinstall = array('ProcessTemplate');
	...
	function undoChange() {
		if ($this->hasError()) $this->sendError();
		if ($this->isApplied()) {
			vtlib_toggleModuleAccess('ProcessTemplate',false);
			$this->sendMsg('ProcessTemplate deactivated!');
