...
class addVtappsecurity extends cbupdaterWorker {
	...
	function undoChange() {
		if ($this->hasError()) $this->sendError();
		if ($this->isApplied()) {
			vtlib_toggleModuleAccess('VtappSecurity',false);
			$this->sendMsg('VtappSecurity deactivated!');
