...
class addcuestionario extends cbupdaterWorker {
	...
	function undoChange() {
		if ($this->hasError()) $this->sendError();
		if ($this->isApplied()) {
			vtlib_toggleModuleAccess('Cuestionario',false);
			$this->sendMsg('Cuestionario deactivated!');
