...
class UserSettingsImport extends cbupdaterWorker {
	...
	function undoChange() {
		if ($this->hasError()) $this->sendError();
		if ($this->isApplied()) {
			vtlib_toggleModuleAccess('UserSettings',false);
			$this->sendMsg('UserSettings deactivated!');
