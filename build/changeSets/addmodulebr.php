...
class addmodulebr extends cbupdaterWorker {
	...
	function undoChange() {
		if ($this->hasError()) $this->sendError();
		if ($this->isApplied()) {
			vtlib_toggleModuleAccess('BusinessRules',false);
			$this->sendMsg('BusinessRules deactivated!');
