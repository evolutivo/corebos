	...
	protected function execute(InputInterface $input, OutputInterface $output) {
		...
		$temppathrel = "Smarty/templates_c/$name.field.php";
                ...
                $question = new ChoiceQuestion(
                    'Please select one block for module '.$module_name, $blocks, 0
                );
                ...
                $question2 = new ChoiceQuestion(
                    'Please select the column type of the field ', $tdata, 0
                );
                ...
                $question4 = new ChoiceQuestion(
                    "Is the field optional or mandatory ", array("O","M"), 0
                );
